    ...
    const [dataTrend, setDataTrend] = useState([
        {
            ...
            images: require('../../assets/airpods1.png'),
        },
        {
            id: '2',
            name: 'AirPods Pro',
            price: '$249.00',
            content: 'or $41.50/mo.per month for 6 mo.',
            images: require('../../assets/airpod-pro.jpg'),
        },
        {
            id: '3',
            name: 'Iphone 8S plus',
            ...
            <View style={styles.header}>
                ...
                <View>
                    ...
                    <View style={{flexDirection: 'row'}}>
                        <Text style={{fontSize: 28, fontWeight: 'bold', marginLeft:10}}>AirsPod</Text>
                    </View>
