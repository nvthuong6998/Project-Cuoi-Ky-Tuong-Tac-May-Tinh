    ...
    return (
        ...
        <SafeAreaView style={{flex: 1, backgroundColor:COLORS.white}}>
            ...
            <View>
                ...
                {/* <Text style={ {display: showText ? 'none': 'flex', fontSize: 16,  marginLeft:20, paddingTop: 5, color: 'red'}}>2020/2021</Text> */}
            </View>
                ...
                <FlatList 
                    ...
                    renderItem={({item}) => (
                        ...
                        >
                            ...
                            <View style={{flexDirection: 'row'}}>
                                <Text>{item.name}</Text>
                                <Text  style={{display: showText ? 'none': 'flex',color: 'red', paddingLeft: 10}}>{item.new}</Text>
                            </View>
